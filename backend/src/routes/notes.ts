...
// Application-scoped routes: mounted at /api/v1/applications
export const noteApplicationRoutes = Router();

// GET /api/v1/applications/:applicationId/notes — List notes for an application
noteApplicationRoutes.get('/:applicationId/notes', async (req: Request, res: Response) => {
  try {
...
noteApplicationRoutes.post('/:applicationId/notes', async (req: Request, res: Response) => {
  try {
...
// Direct note routes: mounted at /api/v1/notes
export const noteDirectRoutes = Router();

// DELETE /api/v1/notes/:id — Delete a note
noteDirectRoutes.delete('/:id', async (req: Request, res: Response) => {
  try {
